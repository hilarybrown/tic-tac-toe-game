...
var onGetStats = function onGetStats(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  gameApi.getStats(data).then(gameUi.getStatsSuccess).catch(gameUi.getStatsFailure);
};
...
var setBoxSymbol = function setBoxSymbol(player, index) {
...
var setClickValue = function setClickValue() {
  ...
  if ($(this).text() === '') {
    ...
    // if box is not empty, display message
...
var findWinner = function findWinner(index, value) {
  // start with winner = false & when a winning combo is found, winner is then set to true
  winner = false;
  if (gameBoard[0] !== '' && gameBoard[0] === gameBoard[3] && gameBoard[3] === gameBoard[6] || gameBoard[1] !== '' && gameBoard[1] === gameBoard[4] && gameBoard[4] === gameBoard[7] || gameBoard[2] !== '' && gameBoard[2] === gameBoard[5] && gameBoard[5] === gameBoard[8] || gameBoard[0] !== '' && gameBoard[0] === gameBoard[1] && gameBoard[1] === gameBoard[2] || gameBoard[3] !== '' && gameBoard[3] === gameBoard[4] && gameBoard[4] === gameBoard[5] || gameBoard[6] !== '' && gameBoard[6] === gameBoard[7] && gameBoard[7] === gameBoard[8] || gameBoard[0] !== '' && gameBoard[0] === gameBoard[4] && gameBoard[4] === gameBoard[8] || gameBoard[2] !== '' && gameBoard[2] === gameBoard[4] && gameBoard[4] === gameBoard[6]) {
    winner = true;
    $('#winner-message').show();
...
var moreMoves = void 0;
// determine if there's no winner in a game
var noWinner = function noWinner() {
  moreMoves = true;
...
var getStatsFailure = function getStatsFailure(data) {
